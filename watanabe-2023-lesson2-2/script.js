...
const expname = "watanabe-2023-lesson2-2-";  // 【要設定変更1/2】 実験名
...
jsPsych.run([preload,enter_fullscreen,par_id,pre_hello,pre_trials,pre_bye,hello,trials,save_data,bye,exit_fullscreen]);
